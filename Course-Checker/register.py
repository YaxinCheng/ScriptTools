...
parser.add_argument('NetID', help='NetID of Dalhousie University')
parser.add_argument('Password', help='Password of your net id')
...
parser.add_argument('-t', '--term', help='Term (Available input: winter/fall/summer/w/f/s; fall and winter by default)')
parser.add_argument('-c', '--crn', type=int, nargs='+', help='Course CRN (You can only register at most 10 courses at once')
...
def register():
    ...
    while going:
        ...
        loginResponse = session.post(LOGIN_URL, {'sid': args.NetID, 'PIN': args.Password})
